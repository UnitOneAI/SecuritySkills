...
| Customer-Managed Webhook Destination Review | `skills/appsec/customer-managed-webhook-destination-review/` | OWASP ASVS 4.0.3, OWASP API Security Top 10 2023, NIST SP 800-53 Rev. 5 |
