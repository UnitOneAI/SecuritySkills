...
| API Schema Shadow Field Review | `skills/appsec/api-schema-shadow-field-review/SKILL.md` | OWASP API Security Top 10 2023, OWASP ASVS, CWE |
...
| **AppSec Engineer** | Application security design, testing, and code review | threat-modeling, secure-code-review, api-security, api-schema-shadow-field-review, dependency-scanning, prompt-injection, owasp-top-10-web |
