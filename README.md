...
| **AppSec Engineer** | Application security design, testing, and code review | threat-modeling, secure-code-review, api-security, tenant-aware-cache-key-review, dependency-scanning, prompt-injection, owasp-top-10-web |
