...
**Skills:** All skills referenced in this bundle are available: `threat-modeling`, `secure-code-review`, `llm-top-10`, `prompt-injection`, `api-security`, `dependency-scanning`, `mobile-secret-storage-review`, `owasp-top-10-web`, `sast-config`, `agent-security`.
